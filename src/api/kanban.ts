...
export const getKanbanBoard = async (projectId: ProjectId): Promise<KanbanBoard> => {
  const boards = await apiRequest<KanbanBoard[]>('/kanbanBoards', { query: { projectId } })
...
export const saveKanbanBoard = async (board: KanbanBoard): Promise<KanbanBoard> => {
